...
public class DukeApplicationTest extends ApplicationTest {
    ...
    protected void click (Scene scene, int x, int y) {
        simulateAction(x, y, () -> scene.getOnMouseClicked().handle(new MouseEvent(MouseEvent.MOUSE_CLICKED, x, y, x, y, MouseButton.PRIMARY, 1,
                                               false, false, false, false, true, false, false, true, false, false, null)));
    }

    protected void moveTo (Scene scene, int x, int y) {
        simulateAction(x, y, () -> scene.getOnMouseMoved().handle(new MouseEvent(MouseEvent.MOUSE_MOVED, x, y, x, y, MouseButton.NONE, 0,
